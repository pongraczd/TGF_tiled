function TGF_tiled_par(ComPoints, tiles, DetailedDEM, DetailedREF, MassDensity, TessDEM, TessREF,TessDensity, CoarseDEM, CoarseREF,CoarseDensity,GlobalDEM,GlobalREF, outname,ikind, itype,idensity, flag_earth,rzones, e)
    % ---------------------- Input parameters -----------------------------------------
    ...
    for i=1:tiles(1)
        for j=1:tiles(2)
            ...
            if sum(index_points)>=1
                ...
                TGF_util_par(comPointsTile, DetailedDEM_struct, DetailedREF_struct,MassDensity_struct, TessDEM_struct, TessREF_struct, ...
